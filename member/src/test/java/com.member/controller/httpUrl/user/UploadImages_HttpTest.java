 ...
 */
public class UploadImages_HttpTest extends MemberTestBase {
    private Logger aLoger=Logger.getLogger(UploadImages_HttpTest.class);
    ...
    @Test(dataProvider = "CsvDataProvider",dataProviderClass = CsvDataProvider.class,threadPoolSize = 3, invocationCount = 5,  timeOut = 10000)
...
//        String url = HttpPostUrlEnum.SDG_UPLOADIMAGES_URL.getUrl();
        String url = HttpPostUrlEnum.ITEMCENTER_UPLOADIMAGE_URL.getUrl();

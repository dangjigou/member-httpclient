 ...
 */
public class BatchUnbindLabel_HttpTest extends MemberTestBase {
    /**
     * 脚本说明：
     * case01: 正常用例,批量解绑spu绑定的商品标签
     * case02: 分支用例,spuId为空
     * case03: 分支用例,spuId为null
     * case04: 分支用例,spuId不存在
     * case05: 分支用例,labelIds为空
     * case06: 分支用例,labelIds为null
     * case07: 分支用例,labelIds不存在
     **/

    @Test(dataProvider = "CsvDataProvider", dataProviderClass = CsvDataProvider.class)
    public void batchUnbindLabel_HttpTest(final String caseId, final String description, String status, String resultCode,String spuId,String labelIds ) {
        final String case_id = MemberTestBase.getCaseId(caseId);
        String res = null;
        String url = HttpPostUrlEnum.SDG_BATCHUNBINDLABEL_URL.getUrl();
